...
export interface ApiPedidoPedido extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cliente: Attribute.Relation<
      ...
      'api::cliente.cliente'
    >;
    detalles: Attribute.RichText & Attribute.Required;
...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    UID: Attribute.UID & Attribute.DefaultTo<'Pro'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPromptPrompt extends Schema.CollectionType {
  ...
  attributes: {
    tema: Attribute.String & Attribute.Required;
    contexto: Attribute.RichText & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
